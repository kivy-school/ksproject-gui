...
from ._datamodel import KivySchoolData # generated from models.yaml

class PyProjectData(KivySchoolData):
    """
    ...
    android = ObjectProperty(None, allownone=True) # type: ObjectProperty[KivySchoolData.Android | None]
    ios = ObjectProperty(None, allownone=True) # type: ObjectProperty[KivySchoolData.IOS | None]
    macos = ObjectProperty(None, allownone=True) # type: ObjectProperty[KivySchoolData.MacOS | None]
