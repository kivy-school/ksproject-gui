...
class KivySchoolData(EventDispatcher):
    ...
    class IOS(EventDispatcher):
        ...
        site_frameworks = ListProperty(allownone=True) # type: ListProperty[str]
    ...
    class MacOS(EventDispatcher):
        ...
        info_plist = DictProperty(allownone=True) # type: dict[str, object] | None
        
        entitlements = DictProperty(allownone=True) # type: dict[str, object] | None
        
        permissions = ListProperty(allownone=True) # type: ListProperty[str]
        
        frameworks = ListProperty(allownone=True) # type: ListProperty[str]
